...
QT_MOC_LITERAL(1, 6, 13), // "filter_result"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "const int*"
QT_MOC_LITERAL(4, 32, 12), // "filterResult"
QT_MOC_LITERAL(5, 45, 4) // "size"

    },
    "QtApp\0filter_result\0\0const int*\0"
    "filterResult\0size"
};
...
void QtApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->filter_result((*reinterpret_cast< const int*(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
