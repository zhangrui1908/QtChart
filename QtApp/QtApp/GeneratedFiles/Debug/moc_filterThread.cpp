...
QT_MOC_LITERAL(1, 13, 18), // "send_filter_result"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 10), // "const int*"
QT_MOC_LITERAL(4, 44, 12), // "filterResult"
QT_MOC_LITERAL(5, 57, 4) // "size"

    },
    "filterThread\0send_filter_result\0\0"
    "const int*\0filterResult\0size"
};
...
void filterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_filter_result((*reinterpret_cast< const int*(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (filterThread::*)(const int * , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filterThread::send_filter_result)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void filterThread::send_filter_result(const int * _t1, const int _t2)
{
